...
import pytest
from PyQt5.QtWidgets import QApplication, QHBoxLayout, QLabel, QPushButton, QScrollArea
...
@pytest.mark.parametrize("width,height", [(1050, 680), (760, 560)])
def test_profile_cards_fit_real_scroll_container_without_horizontal_overflow(
    qapp, tmp_path, width, height
):
    page = _cards_page(qapp, _store(tmp_path))
    scroll = app_module.MouseHubApp._wrap_scrollable(page)
